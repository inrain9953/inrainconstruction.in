...
export const Main2 = ({ location }) => {
  return (
    <>
      <section data-aos='fade-up' className='flex flex-wrap justify-between'>
        <div className='md:m-10 m-5 md:ml-28 md:mr-28'>
          <p className='text-2xl font-semibold text-center mb-5 underline'>
            What We Do
          </p>
          <p className='text-md text-justify text-gray-900 drop-shadow-md md:text-lg'>
            At{' '}
