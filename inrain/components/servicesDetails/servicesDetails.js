    ...
    <>
      ...
      <div className="grid grid-cols-2 m-5 gap-3 md:grid-cols-5">
        <Link href={"/services/rainwater-harvesting-system-for-warehouses"}>
          <div
            data-aos="fade-up"
            className="md:h-36 hover:font-semibold text-center justify-center bg-green-500 rounded-xl items-center flex"
          >
        ...
        <Link
          href={
            "/services/fiber-reinforced-polymer-based-rainwater-harvesting-system"
          }
        >
          <div
            data-aos="fade-up"
