...
const RainwaterInDholpur = () => {
  const location = "Dholpur";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-dholpur";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-dholpur";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Dholpur"} />
      <Footer />
    </>
  );
};

export default RainwaterInDholpur;
