...
const RainwaterInChandigarh = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-chandigarh";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-chandigarh";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Chandigarh"} />
      <Footer />
    </>
  );
};

export default RainwaterInChandigarh;
