...
const RainwaterInPanaji = () => {
  const location = "Panaji";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-panaji";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-panaji";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Panaji"} />
      <Footer />
    </>
  );
};

export default RainwaterInPanaji;
