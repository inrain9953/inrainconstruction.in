...
const RainwaterInKishangarh = () => {
  const location = "Kishangarh";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-kishangarh";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-kishangarh";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Kishangarh"} />
      <Footer />
    </>
  );
};

export default RainwaterInKishangarh;
