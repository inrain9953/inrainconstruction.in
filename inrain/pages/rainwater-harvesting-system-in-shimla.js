...
const RainwaterInShimla = () => {
  const location = "Shimla";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-shimla";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-shimla";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Shimla"} />
      <Footer />
    </>
  );
};

export default RainwaterInShimla;
