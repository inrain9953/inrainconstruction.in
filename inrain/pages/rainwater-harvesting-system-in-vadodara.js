...
const RainwaterInVadodara = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-vadodara";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-vadodara";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Vadodara"} />
      <Footer />
    </>
  );
};

export default RainwaterInVadodara;
