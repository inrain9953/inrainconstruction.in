...
const RainwaterInVaranasi = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-varanasi";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-varanasi";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Varanasi"} />
      <Footer />
    </>
  );
};

export default RainwaterInVaranasi;
