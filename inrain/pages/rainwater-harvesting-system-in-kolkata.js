...
const RainwaterInKolkata = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-kolkata";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-kolkata";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Kolkata"} />
      <Footer />
    </>
  );
};

export default RainwaterInKolkata;
