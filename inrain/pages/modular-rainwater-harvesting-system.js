...
const ModularRWH = () => {
  const data = {
    title: `Modular Rainwater Harvesting System | InRain® Construction Private Limited - Delhi, India`,
    desc: `Discover modular rainwater harvesting system for sustainable water management. Learn how to conserve water, reduce stormwater runoff, and ease pressure on groundwater and municipal supplies with effective rainwater collection methods.`,
    keyword: `modular rainwater harvesting system, rainwater harvesting system, sustainable water solutions, rainwater storage tanks, rainwater harvesting benefits, rainwater filters and tanks`,
    canonical: `https://www.inrainconstruction.in/modular-rainwater-harvesting-system`
  }
  ...
  const crumb = [
    ...
    },
    {
      ...
      item: `https://www.inrainconstruction.in/modular-rainwater-harvesting-system`
    }
  ]

  const AboutCity = {
    loc: 'Delhi',
    slug: 'modular-rainwater-harvesting-system',
    pincode: '110001',
    id: 123
  }
  return (
          ...
          <div className='grid gap-10 lg:grid-cols-[1fr_380px]'>
            ...
            >
              ...
              <p className='mt-5 text-base leading-7 text-gray-900'>
                ...
                <strong className='text-gray-900'>
                  {' '}
                  This approach effectively addresses two key concerns: budget
                  and space. It is not only cost-effective but also allows for
              ...
              <p className='mt-5 text-base leading-7 text-gray-900'>
                ...
                for their strength and load-bearing capacity. Areas designated
                for rainwater harvesting with modular systems can even be used
                for vehicle parking. Installation is also quicker compared to
                traditional rainwater harvesting systems. Here are some of the
                key benefits:
              </p>
              ...
              <div className='mt-10 rounded-2xl bg-gradient-to-r from-green-600 to-emerald-500 p-6 text-white'>
                <p className='text-md leading-7'>
                  <strong>
                    The modular rainwater harvesting system offers an affordable
                    and space-efficient way to collect and reuse rainwater.
                  </strong>{' '}
            ...
            <aside className='lg:sticky lg:top-24 h-fit'>
              ...
              <div className='bg-slate-900 mt-5 text-white rounded-[32px] p-7 shadow-xl'>
                ...
                <p className='text-slate-300 leading-6 text-sm mb-5'>
                  Get customized Modular Rainwater Harvesting solutions,
          ...
          >
            <div className='p-8 md:p-12'>
              ...
              <p className='text-md leading-7 text-white/95'>
                ...
                load-bearing and capable of supporting tons of weight, making it
                a far more economical option compared to traditional civil pits.
                ...
                remove and transport to different locations, a flexibility that
                is impossible with civil pits. Holding and recharge capacity can
