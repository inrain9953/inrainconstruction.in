...
const RainwaterInGuwahati = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-guwahati";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-guwahati";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Guwahati"} />
      <Footer />
    </>
  );
};

export default RainwaterInGuwahati;
