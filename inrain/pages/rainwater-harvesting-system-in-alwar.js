...
const RainwaterInAlwar = () => {
  const location = "Alwar";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-alwar";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-alwar";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Alwar"} />
      <Footer />
    </>
  );
};

export default RainwaterInAlwar;
