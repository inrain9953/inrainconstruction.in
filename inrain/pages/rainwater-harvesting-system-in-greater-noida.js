...
const RainwaterInGreaterNoida = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-greater-noida";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-greater-noida";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Greater Noida"} />
      <Footer />
    </>
  );
};

export default RainwaterInGreaterNoida;
