...
const RainwaterInJaisalmer = () => {
  const location = "Jaisalmer";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-jaisalmer";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-jaisalmer";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Jaisalmer"} />
      <Footer />
    </>
  );
};

export default RainwaterInJaisalmer;
