...
const RainwaterInBhagalpur = () => {
  const location = "Bhagalpur";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bhagalpur";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bhagalpur";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Bhagalpur"} />
      <Footer />
    </>
  );
};

export default RainwaterInBhagalpur;
