...
const RainwaterInMathura = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-mathura";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-mathura";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Mathura"} />
      <Footer />
    </>
  );
};

export default RainwaterInMathura;
