...
const RainwaterInBatala = () => {
  const location = "Batala";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-batala";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-batala";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Batala"} />
      <Footer />
    </>
  );
};

export default RainwaterInBatala;
