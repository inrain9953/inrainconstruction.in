...
const RainwaterInJalandhar = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-jalandhar";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-jalandhar";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Jalandhar"} />
      <Footer />
    </>
  );
};

export default RainwaterInJalandhar;
