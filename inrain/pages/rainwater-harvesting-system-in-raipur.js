...
const RainwaterInRaipur = () => {
  const location = "Raipur";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-raipur";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-raipur";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Raipur"} />
      <Footer />
    </>
  );
};

export default RainwaterInRaipur;
