...
const RainwaterInJabalpur = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-jabalpur";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-jabalpur";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Jabalpur"} />
      <Footer />
    </>
  );
};

export default RainwaterInJabalpur;
