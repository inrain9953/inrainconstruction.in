...
const RainwaterInGurgaon = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-gurgaon";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-gurgaon";
  ...
  return (
    ...
    <Head>
      ...
      <Navbar />
      <LocationTarget loc={"Gurgaon"} />
      <Footer />
    </>
  );
};

export default RainwaterInGurgaon;
