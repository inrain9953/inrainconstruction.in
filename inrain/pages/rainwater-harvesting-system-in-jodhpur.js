...
const RainwaterinJodhpur = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-jodhpur";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-jodhpur";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Jodhpur"} />
      <Footer />
    </>
  );
};

export default RainwaterinJodhpur;
