...
const RainwaterinGorakhpur = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-gorakhpur";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-gorakhpur";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Gorakhpur"} />
      <Footer />
    </>
  );
};

export default RainwaterinGorakhpur;
