...
const RainwaterInKakinada = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-kakinada";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-kakinada";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Kakinada"} />
      <Footer />
    </>
  );
};

export default RainwaterInKakinada;
