...
const RainwaterInSrinagar = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-srinagar";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-srinagar";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Srinagar"} />
      <Footer />
    </>
  );
};

export default RainwaterInSrinagar;
