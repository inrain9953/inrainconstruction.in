...
const RainwaterInBathinda = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bathinda";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bathinda";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Bathinda"} />
      <Footer />
    </>
  );
};

export default RainwaterInBathinda;
