...
const RainwaterInHyderabad = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-hyderabad";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-hyderabad";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Hyderabad"} />
      <Footer />
    </>
  );
};

export default RainwaterInHyderabad;
