...
const RainwaterInBelagavi = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-belagavi";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-belagavi";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Belagavi"} />
      <Footer />
    </>
  );
};

export default RainwaterInBelagavi;
