import { InRainImage, ModularLocation } from "@/components/constant";
...
const ModularRainwaterIndia = () => {
  ...
  const title = `Modular Rainwater Harvesting in ${location} | Modular Rainwater Harvesting System Service Provider in ${location}`;
  const desc = `Looking for the best Modular Rainwater Harvesting System in ${location}? We offer top-quality rainwater harvesting solutions at affordable prices. Contact the leading service provider today!`;
  const keyword = `Modular Rainwater Harvesting in ${location}, Rooftop Rainwater Harvesting in ${location}, Rainwater Harvesting System Service Provider in ${location}, Rainwater Harvesting System in ${location}, Polymer Type Rainwater Harvesting System in ${location}, Rainwater Harvesting for Industries in ${location}, Rain Water Harvesting System Manufacturers In ${location}, Rain Water Harvesting System Suppliers In ${location}, Rain Water Harvesting System Exporters, Best Rain Water Harvesting System In ${location}`;
  const canonical =
    "https://www.inrainconstruction.in/modular-rainwater-harvesting-in-india";
  const ogUrl =
    "https://www.inrainconstruction.in/modular-rainwater-harvesting-in-india";
  const ogTitle = `Modular Rainwater Harvesting in ${location} | Modular Rainwater Harvesting System Service Provider in ${location}`;
  const ogDescription = `Looking for the best Modular Rainwater Harvesting System in ${location}? We offer top-quality rainwater harvesting solutions at affordable prices. Contact the leading service provider today!`;
  const twittertitle = `Modular Rainwater Harvesting in ${location} | Modular Rainwater Harvesting System Service Provider in ${location}`;
  ...
  return (
    <>
        ...
        <div data-aos="fade-up" className="md:content-center">
          ...
          <p className="text-md text-justify text-gray-500 drop-shadow-md md:text-xl">
            ...
            <bold className="text-black font-semibold">
              Modular Rainwater Harvesting Systems in India
            </bold>
      ...
      <div className="pt-5">
        ...
        <div className="mt-5">
          <div>
            <div className="md:grid md:grid-cols-6 grid grid-cols-3 p-3 border-2 border-black m-5 md:p-10">
              {ModularLocation.map((item) => (
                <a
                  data-aos="zoom-in-up"
