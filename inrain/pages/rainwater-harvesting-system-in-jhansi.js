...
const RainwaterInJhansi = () => {
  const location = "Jhansi";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-jhansi";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-jhansi";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Jhansi"} />
      <Footer />
    </>
  );
};

export default RainwaterInJhansi;
