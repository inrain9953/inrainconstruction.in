...
const RainwaterInBegusarai = () => {
  const location = "Begusarai";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-begusarai";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-begusarai";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Begusarai"} />
      <Footer />
    </>
  );
};

export default RainwaterInBegusarai;
