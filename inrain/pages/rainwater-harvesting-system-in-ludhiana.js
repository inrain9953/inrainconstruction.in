...
const RainwaterInLudhiana = () => {
  const location = "Ludhiana";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-ludhiana";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-ludhiana";
  ...
  return (
    ...
    <Navbar />
    <LocationTarget loc={"Ludhiana"} />
    <Footer />
    </>
  )
}

export default RainwaterInLudhiana