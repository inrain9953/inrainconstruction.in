...
const RainwaterInAgartala = () => {
  ...
  const keyword = `Rooftop Rainwater Harvesting System in ${location}, Modular Rainwater Harvesting System in ${location}, Rainwater Harvesting Tank in ${location}, Polymer Type Rainwater Harvesting System in ${location}, Storm water Management in ${location}`;
  const canonical =
