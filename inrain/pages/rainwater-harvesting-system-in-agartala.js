...
const RainwaterInAgartala = () => {
  ...
  const keyword = `Rainwater Harvesting System in ${location}, Rooftop Rainwater Harvesting System in ${location}, Rainwater Harvesting System Service Provider in ${location}, Modular Rainwater Harvesting System in ${location}, Rainwater Harvesting Tank in ${location}, Polymer Type Rainwater Harvesting System in ${location}, Storm water Management in ${location}`;
  const canonical =
