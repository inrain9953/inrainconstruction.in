...
const RainwaterInAgartala = () => {
  ...
  const keyword = `Rainwater Harvesting in ${location}, Rooftop Rainwater Harvesting in ${location}, Rainwater Harvesting System Service Provider in ${location}, Modular Rainwater Harvesting in ${location}, Polymer Type Rainwater Harvesting System in ${location}, Rain Water Harvesting System Manufacturers In ${location}, Rain Water Harvesting System Suppliers In ${location}, Rain Water Harvesting System Exporters, Best Rain Water Harvesting System In ${location}`;
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-agartala";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-agartala";
  ...
  const twittertitle =
    `Rainwater Harvesting in ${location} | Rainwater Harvesting System Service Provider in ${location}`;
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Agartala"} />
      <Footer />
    </>
  );
};

export default RainwaterInAgartala;
