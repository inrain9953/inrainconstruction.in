...
const RainwaterInGandhinagar = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-gandhinagar";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-gandhinagar";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Gandhinagar"} />
      <Footer />
    </>
  );
};

export default RainwaterInGandhinagar;
