...
const RainwaterInImphal = () => {
  const location = "Imphal";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-imphal";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-imphal";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Imphal"} />
      <Footer />
    </>
  );
};

export default RainwaterInImphal;
