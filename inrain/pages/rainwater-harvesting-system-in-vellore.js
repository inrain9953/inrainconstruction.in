...
const RainwaterInVellore = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-vellore";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-vellore";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Vellore"} />
      <Footer />
    </>
  );
};

export default RainwaterInVellore;
