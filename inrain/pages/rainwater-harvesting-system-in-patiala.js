...
const RainwaterInPatiala = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-patiala";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-patiala";
  ...
  return (
    ...
    <Navbar />
    <LocationTarget loc={"Patiala"} />
    <Footer />
    </>
  )
}

export default RainwaterInPatiala