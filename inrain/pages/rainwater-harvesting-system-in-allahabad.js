...
const RainwaterInAllahabad = () => {
  const location = "Allahabad";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-allahabad";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-allahabad";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Allahabad"} />
      <Footer />
    </>
  );
};

export default RainwaterInAllahabad;
