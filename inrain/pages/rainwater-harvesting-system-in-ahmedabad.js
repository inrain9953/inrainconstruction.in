...
const RainwaterInAhmedabad = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-ahmedabad";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-ahmedabad";
  ...
  const twittertitle = `Rainwater Harvesting System in ${location} | Rainwater Harvesting System Service Provider in ${location}`;
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Ahmedabad"} />
      <Footer />
    </>
  );
};

export default RainwaterInAhmedabad;
