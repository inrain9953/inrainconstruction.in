...
const RainwaterInBhilwara = () => {
  const location = "Bhilwara";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bhilwara";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bhilwara";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Bhilwara"} />
      <Footer />
    </>
  );
};

export default RainwaterInBhilwara;
