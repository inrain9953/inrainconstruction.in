...
const RainwaterInFaridabad = () => {
  const location = "Faridabad";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-faridabad";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-faridabad";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Faridabad"} />
      <Footer />
    </>
  );
};

export default RainwaterInFaridabad;
