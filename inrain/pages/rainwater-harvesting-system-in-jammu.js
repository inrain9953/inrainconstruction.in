...
const RainwaterInJammu = () => {
  const location = "Jammu";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-jammu";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-jammu";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Jammu"} />
      <Footer />
    </>
  );
};

export default RainwaterInJammu;
