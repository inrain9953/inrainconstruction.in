...
const RainwaterInGwalior = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-gwalior";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-gwalior";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Gwalior"} />
      <Footer />
    </>
  );
};

export default RainwaterInGwalior;
