...
const RainwaterInVisakhapatnam = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-visakhapatnam";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-visakhapatnam";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Visakhapatnam"} />
      <Footer />
    </>
  );
};

export default RainwaterInVisakhapatnam;
