...
const RainwaterInUjjain = () => {
  const location = "Ujjain";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-ujjain";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-ujjain";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Ujjain"} />
      <Footer />
    </>
  );
};

export default RainwaterInUjjain;
