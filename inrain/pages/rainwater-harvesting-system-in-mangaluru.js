...
const RainwaterInMangaluru = () => {
  const location = "Mangaluru";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-mangaluru";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-mangaluru";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Mangaluru"} />
      <Footer />
    </>
  );
};

export default RainwaterInMangaluru;
