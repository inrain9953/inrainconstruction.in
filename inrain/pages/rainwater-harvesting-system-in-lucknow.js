...
const RainwaterInLucknow = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-lucknow";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-lucknow";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Lucknow"} />
      <Footer />
    </>
  );
};

export default RainwaterInLucknow;
