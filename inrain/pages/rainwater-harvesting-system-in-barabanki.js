...
const RainwaterInBarabanki = () => {
  const location = "Barabanki";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-barabanki";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-barabanki";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Barabanki"} />
      <Footer />
    </>
  );
};

export default RainwaterInBarabanki;
