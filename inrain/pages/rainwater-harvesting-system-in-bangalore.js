...
const RainwaterInBangalore = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bangalore";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bangalore";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Bangalore"} />
      <Footer />
    </>
  );
};

export default RainwaterInBangalore;
