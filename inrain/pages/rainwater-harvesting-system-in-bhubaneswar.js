...
const RainwaterInBhubaneswar = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bhubaneswar";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bhubaneswar";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Bhubaneswar"} />
      <Footer />
    </>
  );
};

export default RainwaterInBhubaneswar;
