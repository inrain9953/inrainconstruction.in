...
const RainwaterInBareilly = () => {
  const location = "Bareilly";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bareilly";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bareilly";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Bareilly"} />
      <Footer />
    </>
  );
};

export default RainwaterInBareilly;
