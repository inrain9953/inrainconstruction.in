...
const RainwaterInDehradun = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-dehradun";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-dehradun";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Dehradun"} />
      <Footer />
    </>
  );
};

export default RainwaterInDehradun;
