...
const RainwaterInChennai = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-chennai";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-chennai";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Chennai"} />
      <Footer />
    </>
  );
};

export default RainwaterInChennai;
