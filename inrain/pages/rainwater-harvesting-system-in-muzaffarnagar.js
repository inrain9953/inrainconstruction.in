...
const RainwaterInMuzaffarnagar = () => {
  const location = "Muzaffarnagar";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-muzaffarnagar";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-muzaffarnagar";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Muzaffarnagar"} />
      <Footer />
    </>
  );
};

export default RainwaterInMuzaffarnagar;
