...
const RainwaterInGhaziabad = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-ghaziabad";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-ghaziabad";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Ghaziabad"} />
      <Footer />
    </>
  );
};

export default RainwaterInGhaziabad;
