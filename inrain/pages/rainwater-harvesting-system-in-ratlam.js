...
const RainwaterInRatlam = () => {
  const location = "Ratlam";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-ratlam";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-ratlam";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Ratlam"} />
      <Footer />
    </>
  );
};

export default RainwaterInRatlam;
