...
const RainwaterInAyodhya = () => {
  const location = "Ayodhya";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-ayodhya";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-ayodhya";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Ayodhya"} />
      <Footer />
    </>
  );
};

export default RainwaterInAyodhya;
