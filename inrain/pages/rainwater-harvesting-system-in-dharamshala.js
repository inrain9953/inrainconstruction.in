...
const RainwaterInDharamshala = () => {
  const location = "Dharamshala";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-dharamshala";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-dharamshala";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Dharamshala"} />
      <Footer />
    </>
  );
};

export default RainwaterInDharamshala;
