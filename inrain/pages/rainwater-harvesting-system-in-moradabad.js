...
const RainwaterInMoradabad = () => {
  const location = "Moradabad";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-moradabad";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-moradabad";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Moradabad"} />
      <Footer />
    </>
  );
};

export default RainwaterInMoradabad;
