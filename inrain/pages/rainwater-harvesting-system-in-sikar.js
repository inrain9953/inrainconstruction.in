...
const RainwaterInSikar = () => {
  const location = "Sikar";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-sikar";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-sikar";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Sikar"} />
      <Footer />
    </>
  );
};

export default RainwaterInSikar;
