...
const RainwaterInBikaner = () => {
  const location = "Bikaner";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bikaner";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-bikaner";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Bikaner"} />
      <Footer />
    </>
  );
};

export default RainwaterInBikaner;
