...
const RainwaterInAligarh = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-aligarh";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-aligarh";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Aligarh"} />
      <Footer />
    </>
  );
};

export default RainwaterInAligarh;
