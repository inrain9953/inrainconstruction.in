...
const RainwaterInTirupati = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-tirupati";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-tirupati";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Tirupati"} />
      <Footer />
    </>
  );
};

export default RainwaterInTirupati;
