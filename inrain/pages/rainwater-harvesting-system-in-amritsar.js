...
const RainwaterInAmritsar = () => {
  const location = "Amritsar";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-amritsar";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-amritsar";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Amritsar"} />
      <Footer />
    </>
  );
};

export default RainwaterInAmritsar;
