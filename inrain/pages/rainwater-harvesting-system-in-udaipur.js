...
const RainwaterInUdaipur = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-udaipur";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-udaipur";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Udaipur"} />
      <Footer />
    </>
  );
};

export default RainwaterInUdaipur;
