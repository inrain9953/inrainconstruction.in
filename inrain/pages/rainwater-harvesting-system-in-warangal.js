...
const RainwaterInWarangal = () => {
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-warangal";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-warangal";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Warangal"} />
      <Footer />
    </>
  );
};

export default RainwaterInWarangal;
