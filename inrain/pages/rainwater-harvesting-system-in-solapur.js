...
const RainwaterInSolapur = () => {
  const location = "Solapur";
  ...
  const canonical =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-solapur";
  const ogUrl =
    "https://www.inrainconstruction.in/rainwater-harvesting-system-in-solapur";
  ...
  return (
    <>
      ...
      <Navbar />
      <LocationTarget loc={"Solapur"} />
      <Footer />
    </>
  );
};

export default RainwaterInSolapur;
